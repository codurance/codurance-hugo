...
type: blog
layout: post
slug: Publish-subscribe-model-in-Kafka
aliases: 
  - /2016/05/16/publish-subscribe-model-in-kafka/
---
...
{{< blog_image src="/assets/img/custom/blog/topic.png" title="Kafka's topic" >}}
...
In the [previous post](/2016/05/10/finite-state-machines-with-akka/) we have defined some Finite State Machine actor that is waiting for `ItemDeleted` messages.
...
[Part 1](/2016/04/28/async-systems-with-sync-clients/) | [Part 2](/2016/04/30/akka-basics/) | [Part 3](/2016/05/10/finite-state-machines-with-akka/)
