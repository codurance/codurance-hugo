...
aliases: 
  - /2013/01/12/spring-integration-based-dispatcher-worker-with-worker-queues/
---
...
{{< blog_image src="http://mashb.files.wordpress.com/2013/01/dispatcher-worker.png" title="Dispatcher Worker" >}}
