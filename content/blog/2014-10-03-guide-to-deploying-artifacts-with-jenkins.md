...
type: blog
layout: post
slug: quick-guide-to-deploying-artifacts-with-Jenkins
aliases: 
  - /2014/10/03/guide-to-deploying-artifacts-with-jenkins/
---
...
{{< blog_image src="/assets/img/custom/blog/jenkinsPost/archiveArtifacts.png" title="Archive artifacts build step" >}}
...
{{< blog_image src="/assets/img/custom/blog/jenkinsPost/copyArtifacts.png" title="Archive artifacts build step" >}}
...
{{< blog_image src="/assets/img/custom/blog/jenkinsPost/console.png" title="Archive artifacts build step" >}}
